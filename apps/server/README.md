...
| AUTHZ_SERVICE_ID     | When `AUTH_ENABLED` is `true`  | String       | -           | Service ID configured for your app from AuthZ.                                                                                                          |
| AUTHZ_SERVICE_UUID   | When `AUTH_ENABLED` is `true`  | String       | -           | Unique Id provided by AuthZ needed for the creation of verification tokens.                                                                             |
